...
\end{equation}
%
where $\mD_{c,m}$ is a circulant matrix capturing channel $c$ of the $m$th filter of the dictionary. Circulant matrices are diagonalizable with Fourier eigenvectors:
%
\begin{equation}
\mD = \begin{bmatrix}
