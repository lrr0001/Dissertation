...
% Nomenclature
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\addcontentsline{toc}{chapter}{Nomenclature and Abreviations}
\input{nomenclature.tex}
\addtocontents{toc}{\cftpagenumbersoff{chapter}} 

\currentpdfbookmark{Nomenclature and Abreviations}{nomenclature}
\addtocontents{toc}{\cftpagenumberson{chapter}} 
...
\input{MultiChannelSignals.tex}

%%%%%%%%%%%%%%%%
% Chapter 3
%%%%%%%%%%%%%%%%

\input{MultiLayerDictionaries.tex}

%%%%%%%%%%%%%%%%
% Chapter 4
%%%%%%%%%%%%%%%%

\input{JPEGArtifactRemoval.tex}

%%%%%%%%%%%%%%%%
% Chapter 5
%%%%%%%%%%%%%%%%

\input{PracticalConsiderationsUsingTensorFlow.tex}
