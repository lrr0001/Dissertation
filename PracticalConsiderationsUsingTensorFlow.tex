...
There are no constraints, so no dual variables are needed. Just alternate between a Tikonov update for $\vx$ and an update for $\vv$ that closely resembles the $\vv$ update from the last chapter.
