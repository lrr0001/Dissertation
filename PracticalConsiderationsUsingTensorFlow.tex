...
There are no constraints, so no dual variables are needed. Jut alternate between a Tikonov update for $\vx$ and an update for $\vv$ that closely resembles the $\vv$ update from the last chapert.
