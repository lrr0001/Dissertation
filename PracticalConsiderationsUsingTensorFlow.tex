...
Specify the custom gradient computations for the gradient of operation $f$ in respect to $y$ as the custom gradient for operation $g$ in respect to $y$. Specify the custom gradient of operation $g$ in respect $z$ as tf.identity($z$). \TODO{These should be code snipets, not equations, but I guess I will fix it later.}
