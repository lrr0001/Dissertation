...
\end{equation}
%
Putting things back in matrix form,\footnote{Recall, while indexing was dropped for brevity, equation \ref{equation:z-update with implicit index} is implicitly indexed.}
%
\begin{equation}
